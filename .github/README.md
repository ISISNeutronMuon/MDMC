...
- `ci-dependabot.yml` is an alternate version of \texttt{ci-build.yml}, but with minimal use of secrets. This is because Dependabot does not have access to repository secrets.
