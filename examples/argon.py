...
simulation = Simulation(
    universe, engine="lammps", time_step=10.18893, temperature=120.0, traj_step=15
)
...
control = Control(
    simulation=simulation, exp_datasets=exp_datasets, fit_parameters=fit_parameters, MD_steps=570
)
