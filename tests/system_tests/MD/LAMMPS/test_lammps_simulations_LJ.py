...
NVE_EXPECTED = {'Atoms':(N_MOLECULES*3, 0),
                'Bonds':(N_MOLECULES*2, 0),
                'Angles':(N_MOLECULES, 0),
                'KinEng': (1440.08, 4.97),
                'PotEng': (-1284.02, 2.7),
                'Temp': (1120.92, 3.87),
                'Press': (16869.52, 131.4),
                'Volume': (DIMENSION ** 3, 0.0),
                'E_bond': (0.0, 0.0),
                'E_angle': (0.0, 0.0),
                'E_vdwl': (381.63, 3.02),
                'E_coul': (11562.6, 3.29),
                'E_long': (-13228.25, 0.35),
                'Nbuild': (893.74, 3.96),
                'Ndanger': (0.0, 0.0)}

NVT_EXPECTED = {'Atoms':(N_MOLECULES*3, 0),
                'Bonds':(N_MOLECULES*2, 0),
                'Angles':(N_MOLECULES, 0),
                'KinEng': (382.61, 0.93),
                'PotEng': (-2416.22, 5.36),
                ...
                'E_angle': (0.0, 0.0),
                'E_vdwl': (458.45, 3.81),
                'E_coul': (10380.53, 8.63),
                'E_long': (-13255.2, 0.13),
                'Nbuild': (381.53, 2.5),
                'Ndanger': (0.0, 0.0)}

NPT_EXPECTED = {'Atoms':(N_MOLECULES*3, 0),
                'Bonds':(N_MOLECULES*2, 0),
                'Angles':(N_MOLECULES, 0),
                'KinEng': (382.7, 1.07),
                'PotEng': (-2412.9, 3.62),
                'Temp': (297.88, 0.83),
                'Press': (3.45, 31.15),
                'Volume': (6473.89, 35.17),
                'E_bond': (0.0, 0.0),
                'E_angle': (0.0, 0.0),
                'E_vdwl': (457.49, 2.77),
                'E_coul': (10378.14, 17.79),
                'E_long': (-13248.54, 16.16),
                'Nbuild': (415.66, 3.07),
                'Ndanger': (0.0, 0.0)}
...
NVE_UNCONSTRAINED_EXPECTED = {'Atoms':(N_MOLECULES*3, 0),
                              ...
                              'PotEng': (-1284.95, 4.63),
                              'Temp': (1123.8, 5.37),
                              'Press': (16903.53, 229.0),
                              'Volume': (DIMENSION ** 3, 0.0),
                              'E_bond': (0.0, 0.0),
                              'E_angle': (0.0, 0.0),
                              'E_vdwl': (382.68, 6.41),
                              'E_coul': (11560.65, 8.44),
                              'E_long': (-13228.29, 0.59),
                              'Nbuild': (93.24, 1.58),
                              'Ndanger': (0.0, 0.0)
