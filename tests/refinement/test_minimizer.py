...
def test_minimizer_fixed_parameter():
    ...
    with pytest.raises(ValueError):
        for minimizer_name in MinimizerFactory.available_names():
            _ = MinimizerFactory.create(minimizer_name, mockcontrol, parameters)
...
def test_minimizer_tied_parameter():
    ...
    with pytest.raises(ValueError):
        for minimizer_name in MinimizerFactory.available_names():
            minim = MinimizerFactory.create(minimizer_name, mockcontrol, parameters)
