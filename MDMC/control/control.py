    ...
    **settings: Any, optional
    ...
    def __init__(
        ...
        **settings: Any,
        ...
        self.results_filename = results_filename or f"results{timestamp_now()}.csv"

        settings["time_step_reductions"] = time_step_reductions
        ...
        if previous_history is not None:
            self.minimizer.previous_history = previous_history
        if hasattr(self.minimizer, "n_steps"):
            self.minimizer.n_steps = n_steps
        ...
        data_array = [
            ["-"],
            [type(self.minimizer).__name__],
            [type(self.FoM_calculator).__name__],
        ...
        if print_all_settings:
            ...
            for key, val in {
                ...
                "time_step_reductions": time_step_reductions,
            ...
            data_array.append(["-"])
            for parameter in self.fit_parameters.values():
    ...
    def fit_parameters(self) -> Parameters:
        """Get parameters of fit from minimizer.
    ...
    @property
    def previous_history(self) -> Path | str | None:
        """Get previous history from minimizer.
        ...
        Path or str or None
            Previous history.
        """
        return self.minimizer.previous_history
