...
from MDMC.MD.simulation import PPPM, Ewald, KSpaceSolver, Universe
...
class OpenMMEngine(MDEngine):
    ...
    def setup_universe(self, universe: Universe, **settings: Any) -> None:
        ...
        **settings
        ...
        box_matrix = np.diag(self.universe.dimensions) * unit.angstrom
    ...
    def setup_simulation(
        ...
        openmm_platform: OpenmmPlatforms | None = None,
